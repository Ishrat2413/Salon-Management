...
export default function RegisterPage() {
  return (
    <div className="flex h-[100dvh] bg-[#fef8f8] items-center justify-center p-4 sm:p-8">
      <div className="w-full h-full 2xl:px-40 xl:px-32 lg:px-24 md:px-12 sm:px-8 px-0 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-25 items-stretch">
        ...
        {/* Right Side: Form */}
        <div className="w-full h-full overflow-y-auto mx-auto md:mx-0 pr-2 md:pr-6 pb-10 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
